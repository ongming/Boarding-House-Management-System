...
import com.example.house.model.dto.admin.AdminRevenueRow;
...
public class JpaAdminDataStore implements AdminDataStore {
    private final AdminDomainService adminService;
    ...
    public JpaAdminDataStore(AdminDomainService adminService) {
        this.adminService = adminService;
        refreshAll();
    }

    @Override
    public ObservableList<RateItem> rateConfigs() { return rateConfigs; }
    @Override
    public ObservableList<RoomItem> rooms() { return rooms; }
    @Override
    public ObservableList<StaffAccountItem> staffAccounts() { return staffAccounts; }
    @Override
    public ObservableList<RevenueRow> revenueRows() { return revenueRows; }
    @Override
    public ObservableList<CheckoutItem> pendingCheckouts() { return pendingCheckouts; }
    @Override
